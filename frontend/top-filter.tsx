    ...
    <>
      <div className="flex justify-between flex-shrink-0 pl-2 pr-6 border-b border-gray-400 h-14 lg:pl-9 border-b-color-gray-2">
        ...
        <div className="flex items-center">
          ...
          <div className="p-1 font-semibold cursor-default hover:bg-gray-2">
            {title}
          </div>
          <span>{issues.length}</span>
          <button
            className="px-1 py-0.5 ml-3 border border-gray-3 border-dashed rounded text-gray-500 hover:border-gray-400 focus:outline-none hover:text-gray-800"
        ...
        <div className="flex items-center">
          <div
            className="p-2 rounded hover:bg-gray-2"
